            ...
            enum {
                Traversal = int(MayInnerVectorize) ? int(InnerVectorizedTraversal)
                                        ...
                                        SliceVectorizedTraversal)
                                                                                                      : int(
                                                MayLinearize) ? int(LinearTraversal)
            ...
            enum {
                Unrolling = (int(Traversal) == int(InnerVectorizedTraversal) || int(Traversal) == int(DefaultTraversal))
                            ...
                            : int(Traversal) == int(LinearVectorizedTraversal)
                              ? (bool(MayUnrollCompletely) && bool(DstIsAligned) ? int(CompleteUnrolling) : int(
                                        NoUnrolling))
        ...
        struct assign_impl<Derived1, Derived2, LinearVectorizedTraversal, NoUnrolling, Version> {
            ...
            static EIGEN_STRONG_INLINE void run(Derived1 &dst, const Derived2 &src) {
                ...
                enum {
                    ...
                    dstAlignment = PacketTraits::AlignedOnScalar ? Aligned : int(
...
***************************/
        ...
        struct assign_impl<Derived1, Derived2, SliceVectorizedTraversal, NoUnrolling, Version> {
            ...
            static inline void run(Derived1 &dst, const Derived2 &src) {
                ...
                const Index innerSize = dst.innerSize();
                const Index outerSize = dst.outerSize();
                const Index alignedStep = alignable ? (packetSize - dst.outerStride() % packetSize) & packetAlignedMask
                                                    : 0;
                Index alignedStart = ((!alignable) || bool(dstIsAligned)) ? 0 : internal::first_aligned(dst_ptr,
                                                                                                        innerSize);
