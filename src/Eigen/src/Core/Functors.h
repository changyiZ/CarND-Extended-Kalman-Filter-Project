...
//   [low, ..., low] + ( [step, ..., step] * ( [i, ..., i] + [0, ..., size] ) )
        ...
        struct linspaced_op_impl<Scalar, true> {
            ...
            linspaced_op_impl(const Scalar &low, const Scalar &step) :
                    m_low(low), m_step(step),
                    m_lowPacket(pset1<Packet>(m_low)), m_stepPacket(pset1<Packet>(m_step)),
...
// nested expressions).
        ...
        struct linspaced_op {
            ...
            linspaced_op(const Scalar &low, const Scalar &high, DenseIndex num_steps) : impl(
                    (num_steps == 1 ? high : low),
