  ...
  */
    ...
    public:
        ...
        inline explicit Transform(const EigenBase <OtherDerived> &other) {
            ...
            check_template_params();
            internal::transform_construct_from_matrix<OtherDerived, Mode, Options, Dim, HDim>::run(this,
                                                                                                   other.derived());
        }
        ...
        template<typename OtherDerived>
        friend
        inline const typename internal::transform_left_product_impl<OtherDerived, Mode, Options, _Dim,
                _Dim + 1>::ResultType
...
*****************************************************/
        ...
        struct transform_take_affine_part {
            ...
            static inline AffinePart
            run(MatrixType &m) { return m.template block<TransformType::Dim, TransformType::HDim>(0, 0); }
...
*****************************************************/
        ...
        struct transform_construct_from_matrix<Other, Mode, Options, Dim, HDim, Dim, Dim> {
            static inline void
            run(Transform<typename Other::Scalar, Dim, Mode, Options> *transform, const Other &other) {
