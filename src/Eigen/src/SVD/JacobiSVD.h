 ...
 ***/
        ...
        struct svd_precondition_2x2_block_to_be_real<MatrixType, QRPreconditioner, true> {
            ...
            run(typename SVD::WorkMatrixType &work_matrix, SVD &svd, Index p, Index q, RealScalar &maxDiagEntry) {
                ...
                maxDiagEntry = max EIGEN_EMPTY(maxDiagEntry, max EIGEN_EMPTY(abs(work_matrix.coeff(p, p)),
                ...
                for (Index q = 0; q < p; ++q) {
                    ...
                    if (abs(m_workMatrix.coeff(p, q)) > threshold || abs(m_workMatrix.coeff(q, p)) > threshold) {
                        ...
                        if (internal::svd_precondition_2x2_block_to_be_real<MatrixType, QRPreconditioner>::run(
                            ...
                            maxDiagEntry = max EIGEN_EMPTY(maxDiagEntry, max EIGEN_EMPTY(abs(m_workMatrix.coeff(p, p)),
