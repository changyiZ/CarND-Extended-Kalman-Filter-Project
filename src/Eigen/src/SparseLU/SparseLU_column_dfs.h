...
namespace Eigen {
    ...
    namespace internal {
        ...
        struct column_dfs_traits : no_assignment_operator {
            ...
            column_dfs_traits(Index jcol, Index &jsuper, typename SparseLUImpl<Scalar, Index>::GlobalLU_t &glu,
 ...
 */
        template<typename Scalar, typename Index>
        Index
        SparseLUImpl<Scalar, Index>::column_dfs(const Index m, const Index jcol, IndexVector &perm_r, Index maxsuper,
