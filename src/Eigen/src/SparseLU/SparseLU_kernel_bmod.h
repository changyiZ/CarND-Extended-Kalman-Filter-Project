 ...
 */
        ...
        struct LU_kernel_bmod {
            ...
            run(const int segsize, BlockScalarVector &dense, ScalarVector &tempv, ScalarVector &lusup, Index &luptr,
                const Index lda,
        ...
        LU_kernel_bmod<SegSizeAtCompileTime>::run(const int segsize, BlockScalarVector &dense, ScalarVector &tempv,
        ...
        struct LU_kernel_bmod<1> {
            template<typename BlockScalarVector, typename ScalarVector, typename IndexVector, typename Index>
            static EIGEN_DONT_INLINE void
            run(const int /*segsize*/, BlockScalarVector &dense, ScalarVector & /*tempv*/, ScalarVector &lusup,
                Index &luptr,
        ...
        template<typename BlockScalarVector, typename ScalarVector, typename IndexVector, typename Index>
        EIGEN_DONT_INLINE void
        LU_kernel_bmod<1>::run(const int /*segsize*/, BlockScalarVector &dense, ScalarVector & /*tempv*/,
